      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
        {cards.map((image, index) => {
          ...
          return (
            <article
              key={image.id}
              className="overflow-hidden rounded-lg border border-ucla-100 bg-white/95 shadow-soft"
            >
              <button
                type="button"
              ...
              >
                <div className="relative aspect-[4/3] bg-slate-950">
                  ...
                  <div className="absolute bottom-2 left-2 right-2 rounded-lg border border-ucla-100 bg-white/95 px-3 py-2 text-xs font-semibold text-slate-700 shadow-soft">
